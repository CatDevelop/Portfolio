                            ...
                            <>
                                {
                                    props.tags.map((tag, i) => {
                                        return <p key={props.id+"tag"+i} className={s.projectTag}>{tag}</p>
                                    })
                                }</>
                        ...
                        props.gitURL ?
                            <Link to={props.gitURL} target="_blank" className={s.githubLogo}>
                                <svg width="20" height="20" viewBox="0 0 25 24" fill="none"
                                    ...
                                    <g clipPath="url(#clip0_1551_6946)">
                        ...
                        props.projectURL ?
                            <Link to={props.projectURL} target="_blank" className={s.linkLogo}>
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.8284 10.1716C12.2663 8.60948 9.73367 8.60948 8.17157 10.1716L4.17157 14.1716C2.60948 15.7337 2.60948 18.2663 4.17157 19.8284C5.73367 21.3905 8.26633 21.3905 9.82843 19.8284L10.93 18.7269M10.1716 13.8284C11.7337 15.3905 14.2663 15.3905 15.8284 13.8284L19.8284 9.82843C21.3905 8.26633 21.3905 5.73367 19.8284 4.17157C18.2663 2.60948 15.7337 2.60948 14.1716 4.17157L13.072 5.27118" stroke="#111827" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
