    ...
    const items = [
        {
            ...
            color: "red",
            text: "<b>Победа в хакатоне от Сбера и УрФУ \"Код города 300\"</b>\nСоздали MVP десктопного приложения для распознавания и озвучивания русской жестовой речи, что позволяет слабослышащим удобно общаться в онлайн созвонах и конференциях"
        },
        {
